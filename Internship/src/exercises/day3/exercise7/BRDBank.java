...
public class BRDBank extends BankAccount {

    public BRDBank(String bankName, double accountAmount, String ownerName, String ownerIdNo, String accountIBAN, double interest, Money currency) {
    ...
    public String withdraw(double withdrawnAmount) {
        if (withdrawnAmount < 10 || withdrawnAmount % 10 != 0.0) {
